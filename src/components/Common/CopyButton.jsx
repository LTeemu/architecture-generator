  ...
  return (
    <button
      ...
      style={{ 
        ...
        color: copied ? (darkMode ? "#34d399" : "#16a34a") : (darkMode ? "#cbd5e1" : "#666"), 
        padding: "6px 12px", borderRadius: "6px", cursor: "pointer", fontSize: "12px", fontFamily: "'JetBrains Mono', monospace", fontWeight: 500, whiteSpace: "nowrap" 
      }}>
